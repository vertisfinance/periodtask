...
class CronTest(unittest.TestCase):
    ...
    def test_check_1(self):
        p = Period()
        self.assertEqual(
            p._check(ts('2018-07-09 18:05:00')),
    ...
    def test_check_2(self):
        ...
        self.assertEqual(
            p._check(ts('2018-07-09 18:05:10')),
            '2018-07-09 18:05:10 UTC, MON'
        )
        self.assertEqual(
            p._check(ts('2018-07-09 18:05:15')),
            '2018-07-09 18:05:15 UTC, MON'
        )
        self.assertEqual(
            p._check(ts('2018-07-09 18:05:20')),
            '2018-07-09 18:05:20 UTC, MON'
        )
        self.assertFalse(
            p._check(ts('2018-07-09 18:05:25'))
        )
    ...
    def test_check_3(self):
        ...
        self.assertEqual(
            p._check(ts('2018-07-08 18:05:00')),
    ...
    def test_dow_range(self):
        ...
        self.assertEqual(
            p._check(ts('2018-07-10 18:05:00')),
            '2018-07-10 18:05:00 UTC, TUE'
        )
        self.assertEqual(
            p._check(ts('2018-07-11 18:05:00')),
            '2018-07-11 18:05:00 UTC, WED'
        )
        self.assertFalse(
            p._check(ts('2018-07-12 18:05:00'))
        )

    def test_any_fail(self):
        p = Period('0 */3 0-12 sun/L 7 2018-2020')
        self.assertFalse(p._check(ts('2018-07-12 18:05:00')))
        self.assertFalse(p._check(ts('2018-07-12 18:06:00')))
        self.assertFalse(p._check(ts('2018-08-12 10:06:00')))
        self.assertFalse(p._check(ts('2017-07-12 10:06:00')))
        self.assertFalse(p._check(ts('2018-07-08 10:06:00')))

    def test_first(self):
        p = Period('0 */3 0-12 sun/F 7 2018-2020')
        self.assertEqual(
            p._check(ts('2018-07-01 10:06:00')),
        ...
        self.assertEqual(
            p._check(ts('2018-07-08 10:06:00')),
            '2018-07-08 10:06:00 UTC, SUN'
        )
        self.assertFalse(p._check(ts('2018-07-15 10:06:00')))

        p = Period('0 */3 0-12 sun/FFF 7 2018-2020')
        self.assertEqual(
            p._check(ts('2018-07-15 10:06:00')),
    ...
    def test_last(self):
        p = Period('0 */3 0-12 sun/L 7 2018-2020')
        self.assertEqual(
            p._check(ts('2018-07-29 10:06:00')),
            '2018-07-29 10:06:00 UTC, SUN'
        )
        self.assertFalse(p._check(ts('2018-07-22 10:06:00')))

        p = Period('0 */3 0-12 sun/LL 7 2018-2020')
        self.assertEqual(
            p._check(ts('2018-07-22 10:06:00')),
            '2018-07-22 10:06:00 UTC, SUN'
        )
        self.assertFalse(p._check(ts('2018-07-29 10:06:00')))
        self.assertFalse(p._check(ts('2018-07-15 10:06:00')))
    ...
    def test_more_last_first(self):
        ...
        self.assertEqual(
            p._check(ts('2018-07-01 00:00:00')),
            '2018-07-01 00:00:00 UTC, SUN'
        )
        self.assertEqual(
            p._check(ts('2018-07-29 00:00:00')),
